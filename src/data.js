export default [
...

  {
    ...
    description:
      "Discover hidden gems in the city with a local guide. Experience the hustle and bustle from a new perspective!",
    price: 30,
    coverImg: "katie-zaferes.png",
    stats: {
      rating: 4.5,
  ...
  },
  {
    ...
    title: "Beach Cleanup",
    description:
      "Join a group of eco-conscious individuals in a beach cleanup activity. Make new friends while making a difference!",
    price: 20,
    coverImg: "mountain-bike.png",
    stats: {
      rating: 4.9,
